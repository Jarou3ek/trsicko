...
shutil.copy2(SOURCE / 'Podrobný program rozvoje obcí_2026_2030.pdf', ASSETS / 'podrobny-program.pdf')
shutil.copy2(SOURCE / 'kandidati.png', ASSETS / 'kandidati.png')
...
reader = PdfReader(SOURCE / 'Podrobný program rozvoje obcí_2026_2030.pdf')
